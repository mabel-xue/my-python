...
print(f"\n当日收盘价: {today_close_price:.2f}")
buy_price = today_close_price * (1 + 0.36 / 100)
print(f"+0.36%: {buy_price:.2f}")
buy_price = today_close_price * (1 - 0.36 / 100)
print(f"-0.36%: {buy_price:.2f}")
buy_price = today_close_price * (1 + 0.48 / 100)
print(f"+0.48%: {buy_price:.2f}")
buy_price = today_close_price * (1 - 0.48 / 100)
print(f"-0.48%: {buy_price:.2f}")
buy_price = today_close_price * (1 + 0.60 / 100)
print(f"+0.60%: {buy_price:.2f}")
buy_price = today_close_price * (1 - 0.60 / 100)
print(f"-0.60%: {buy_price:.2f}")
buy_price = today_close_price * (1 + 0.80 / 100)
print(f"+0.80%: {buy_price:.2f}")
buy_price = today_close_price * (1 - 0.80 / 100)
print(f"-0.80%: {buy_price:.2f}")
